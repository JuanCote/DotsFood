...
class DeliveryCallbackTest extends TestCase
{
     ...
     */
    public function testDeliveryCallbackHandle(): void
    {
        ...
        $deliveryCallback = new DishCallback($usersServiceMock, $ordersServiceMock);
        ...
        $deliveryCallback->handle($callbackQuery);
    }
}
